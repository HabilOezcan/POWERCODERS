const showWeatherOnLand = (pData)=>{
    ...
    let content = `
        <ul>
            ...
            <li><img src='../IMGs/icons/sunset1.jpg' alt='sunrise'width='15' height='15'>${pData.sunset} GMT</li>
            <li>Wind Speed : ${pData.wind_spd} m/sn</li>
            <li>Wind Direction : ${pData.wind_dir}</li>
            <li><img src='../IMGs/icons/${pData.weather.icon}.png' alt='sunrise'width='15' height='15'> ${pData.weather.description}</li>
        </ul>
    `;
